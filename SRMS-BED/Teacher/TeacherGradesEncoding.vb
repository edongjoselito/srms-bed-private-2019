...
Public Class TeacherGradesEncoding
    Dim str As String
    ...
    Private Sub btnSelect_Click(sender As Object, e As EventArgs) Handles btnSelect.Click
        frmTeacherSelectsubjects.ShowDialog()
    End Sub
    Public Sub Grades()
        Try
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            str = "select * from grades where SubjectCode='" & txtSubjectcode.Text & "' and Description='" & txtDescription.Text & "' and subComponent='" & subcom & "' and Instructor='" & frmTeacher.lblInstructor.Text & "' and SY='" & frmTeacher.stSY.Text & "' and Sem='" & frmTeacher.stSemester.Text & "' and Section='" & txtSection.Text & "'"
            conn.Open()
            Dim mysda As New MySqlDataAdapter(str, conn)
            Dim ds As New DataSet
