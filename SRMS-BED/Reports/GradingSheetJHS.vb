...
Public Class GradingSheetJHS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.GradingSheetJHS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_subComponent() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedGradingSheetJHS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GradingSheetJHS = New GradingSheetJHS()
        rpt.Site = Me.Site
        Return rpt
    End Function
