...
Public Class ListPerSection
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.ListPerSection.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListPerSection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListPerSection = New ListPerSection()
        rpt.Site = Me.Site
        Return rpt
    End Function
