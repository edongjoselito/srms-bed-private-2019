...
Public Class countPerTrack
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.countPerTrack.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcountPerTrack
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As countPerTrack = New countPerTrack()
        rpt.Site = Me.Site
        Return rpt
    End Function
