...
Public Class PerSpecializationReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PerSpecializationReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.PerSpecializationReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPerSpecializationReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PerSpecializationReport = New PerSpecializationReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
