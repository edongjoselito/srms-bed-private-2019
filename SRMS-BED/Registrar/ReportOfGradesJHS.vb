...
Public Class ReportOfGradesJHS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.ReportOfGradesJHS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportOfGradesJHS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportOfGradesJHS = New ReportOfGradesJHS()
        rpt.Site = Me.Site
        Return rpt
    End Function
