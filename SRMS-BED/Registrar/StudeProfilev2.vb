...
Public Class StudeProfilev2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.StudeProfilev2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudeProfilev2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudeProfilev2 = New StudeProfilev2()
        rpt.Site = Me.Site
        Return rpt
    End Function
