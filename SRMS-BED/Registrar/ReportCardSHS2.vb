...
Public Class ReportCardSHS2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.ReportCardSHS2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportCardSHS2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportCardSHS2 = New ReportCardSHS2()
        rpt.Site = Me.Site
        Return rpt
    End Function
