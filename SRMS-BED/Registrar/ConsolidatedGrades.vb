...
Public Class ConsolidatedGrades
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRMS_BED.ConsolidatedGrades.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidatedGrades
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsolidatedGrades = New ConsolidatedGrades()
        rpt.Site = Me.Site
        Return rpt
    End Function
