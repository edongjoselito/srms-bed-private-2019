    ...
    Private Sub tsSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsSave.Click
        Try
            If txtReasons.Text = "" Then
                ...
                Exit Sub
            End If
            str = "insert into voidreceipts values('0','" & lblID.Text & "','" & txtORNumber.Text & "','" & txtAmount.Text & "','" & Convert.ToDateTime(dtpDatePaid.Text).ToString("yyyy-MM-dd") & "','" & txtParticulars.Text & "','" & txtCashier.Text & "','" & Convert.ToDateTime(dtpVoidDate.Text).ToString("yyyy-MM-dd") & "','" & frmAccounting.stUser.Text & "','" & txtReasons.Text & "')"
            conn.Open()
            ...
            'update billing
            str = "update studeaccount set StudentNumber='" & lblStudentNumber.Text & "',AcctTotal='" & txtTotalAccts.Text & "',TotalPayments='" & txtTotalPayments.Text & "',CurrentBalance='" & txtBalance.Text & "' where StudentNumber='" & lblStudentNumber.Text & "' and SY='" & frmAccounting.stSY.Text & "' and Sem='" & frmAccounting.stSemester.Text & "'"
            conn.Open()
